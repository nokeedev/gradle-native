...
Apply link:https://nokee.dev/docs/{jbake-version}/plugin-references.html[any of the Nokee plugins] to your build just like any other Gradle plugin:
...
* Get familiar with the link:https://nokee.dev/current/manual/user-manual.html[Nokee User Manual]
* Ask on the link:https://discuss.gradle.org/tag/native[native forum]
* Have a look at the link:https://nokee.dev/current/samples[Samples]
* Join the link:https://gradl.es/slack-invite-2019[#native Slack Channel]
