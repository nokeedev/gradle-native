...
import static dev.gradleplugins.buildscript.blocks.ArtifactRepositoryStatement.maven;
import static dev.gradleplugins.buildscript.blocks.ArtifactRepositoryStatement.uri;
import static org.hamcrest.MatcherAssert.assertThat;

class ArtifactRepositoryStatementMavenTest {
	@Test
	void rendersMavenWithUrlOnly() {
		assertThat(maven(uri("https://repo.example.com/release")), visit(
	...
	@Test
	void rendersConfiguredMavenWithUrlOnly() {
		assertThat(maven(t -> t.url(uri("https://repo.example.com/snapshot"))), visit(
			"<block selector='maven'>",
