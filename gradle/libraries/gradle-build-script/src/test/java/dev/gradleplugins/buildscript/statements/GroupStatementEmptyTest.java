...
class GroupStatementEmptyTest {
	private final GroupStatement subject = GroupStatement.empty();
	...
	@Test
	void canBuildEmptyGroupStatementUsingBuilder() {
		assertEquals(subject, GroupStatement.builder().build());
	}
}
