...
import dev.nokee.docs.dsl.source.model.EnumConstantMetaData
...
class JavadocLinkConverterTest extends XmlSpecification {
    final DocLinkBuilder linkRenderer = Mock()
    ...
    def convertsClassNameToLink() {
        ...
        _ * linkRenderer.link({it.name == 'org.gradle.SomeClass'}, listener) >> new DocLinkBuilder.DocLinkImpl(parse('<someLinkElement/>'))
    }
    ...
    def convertsClassAndMethodNameToLink() {
        ...
        _ * linkRenderer.link(method, listener) >> new DocLinkBuilder.DocLinkImpl(parse('<someLinkElement/>'))
    ...
    def convertsEnumConstantLinkToLiteralValue() {
        ...
        _ * linkRenderer.link(enumConstant, listener) >> new DocLinkBuilder.DocLinkImpl(parse('<someLinkElement/>'))
    }
