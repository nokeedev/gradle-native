 ...
 */
package dev.gradleplugins.dockit.dsl.source;
...
import dev.gradleplugins.dockit.dsl.source.model.*;
import dev.gradleplugins.dockit.dsl.source.model.ClassMetaData.MetaType;
...
import static dev.gradleplugins.dockit.dsl.source.model.ClassMetaData.MetaType.*;
...
public class SourceMetaDataVisitor extends VoidVisitorAdapter<ClassMetaDataRepository<ClassMetaData>> {
	...
	public void visit(ClassOrInterfaceDeclaration classDeclaration, ClassMetaDataRepository<ClassMetaData> repository) {
		visitTypeDeclaration(classDeclaration, repository, classDeclaration.isInterface() ? INTERFACE : CLASS, () -> {
	...
	public void visit(EnumDeclaration enumDeclaration, ClassMetaDataRepository<ClassMetaData> repository) {
		visitTypeDeclaration(enumDeclaration, repository, ENUM, () -> {
	...
	public void visit(AnnotationDeclaration annotationDeclaration, ClassMetaDataRepository<ClassMetaData> repository) {
		visitTypeDeclaration(annotationDeclaration, repository, ANNOTATION, () -> {
			super.visit(annotationDeclaration, repository);
		});
	}

	private void visitTypeDeclaration(TypeDeclaration<?> typeDeclaration, ClassMetaDataRepository<ClassMetaData> repository, MetaType metaType, Runnable action) {
