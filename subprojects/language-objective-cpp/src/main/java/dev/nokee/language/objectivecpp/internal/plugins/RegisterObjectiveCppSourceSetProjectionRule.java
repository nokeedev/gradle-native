...
public final class RegisterObjectiveCppSourceSetProjectionRule {
	public static final class LegacySourceSetRule extends ModelActionWithInputs.ModelAction3<ObjectiveCppSourceSetTag, NativeSourceSetLegacyTag, SourceProperty> {
		...
		@Override
		protected void execute(ModelNode entity, ObjectiveCppSourceSetTag cSourceSetSpec, NativeSourceSetLegacyTag nativeSourceSetLegacyTag, SourceProperty sourceProperty) {
	...
	public static final class DefaultSourceSetRule extends ModelActionWithInputs.ModelAction4<ObjectiveCppSourceSetTag, SourceProperty, HeadersProperty, NativeCompileTask> {
		private final ObjectFactory objectFactory;
		...
		@Override
		protected void execute(ModelNode entity, ObjectiveCppSourceSetTag cSourceSetSpec, SourceProperty sourceProperty, HeadersProperty headersProperty, NativeCompileTask compileTask) {
			entity.addComponent(createdUsing(ModelType.of(ObjectiveCppSourceSet.class), () -> objectFactory.newInstance(DefaultObjectiveCppSourceSet.class)));
		}
	}
