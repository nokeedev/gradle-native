...
public final class InitscriptSectionBuilder {
	private final List<Section> sections = new ArrayList<>();

	public InitscriptSectionBuilder dependencies(Consumer<? super DependenciesSectionBuilder> builderAction) {
	...
	Section build() {
		return new NamedSection("initscript", sections);
	}
