...
public final class JavaSourceSetImpl extends AbstractLanguageSourceSetAdapter<JavaSourceSet> implements JavaSourceSet {
	public JavaSourceSetImpl(LanguageSourceSetIdentifier<?> identifier, SourceDirectorySet sourceDirectorySet, ObjectFactory objectFactory) {
		super(identifier, JavaSourceSet.class, sourceDirectorySet, objectFactory);
	}
}
