...
//					}
	...
	public static NodeRegistration javaNativeInterfaceLibrary(String name, Project project) {
		...
		return component(name, JavaNativeInterfaceLibrary.class)
			...
			.withComponent(createdUsing(ModelType.of(JniLibraryComponentInternal.class), () -> new JniLibraryComponentInternal(identifier, GroupId.of(project::getGroup), project.getObjects(), project.getConfigurations(), project.getDependencies(), project.getProviders(), project.getExtensions().getByType(BinaryViewFactory.class), project.getExtensions().getByType(TaskRegistry.class))))
