	...
	, ModelBackedNamedMixIn
{
	...
	protected void onEachVariant(KnownDomainObject<DefaultXCTestTestSuiteVariant> variant) {
		...
		// XCTest Unit Testing
		val processUnitTestPropertyListTask = taskRegistry.register(namer.determineName(TaskIdentifier.of(variantIdentifier, "processUnitTestPropertyList")), ProcessPropertyListTask.class, task -> {
		...
		val createUnitTestXCTestBundle = taskRegistry.register(namer.determineName(TaskIdentifier.of(variantIdentifier, "createUnitTestXCTestBundle")), CreateIosXCTestBundleTask.class, task -> {
		...
		val signUnitTestXCTestBundle = taskRegistry.register(namer.determineName(TaskIdentifier.of(variantIdentifier, "signUnitTestXCTestBundle")), SignIosApplicationBundleTask.class, task -> {
		...
		val createUnitTestApplicationBundleTask = taskRegistry.register(namer.determineName(TaskIdentifier.of(variantIdentifier, "createUnitTestLauncherApplicationBundle")), CreateIosApplicationBundleTask.class, task -> {
		...
		val signTask = taskRegistry.register(namer.determineName(TaskIdentifier.of(variantIdentifier, "signUnitTestLauncherApplicationBundle")), SignIosApplicationBundleTask.class, task -> {
