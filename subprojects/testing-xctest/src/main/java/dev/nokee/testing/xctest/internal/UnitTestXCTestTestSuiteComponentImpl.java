...
@AutoFactory
public class UnitTestXCTestTestSuiteComponentImpl extends BaseXCTestTestSuiteComponent implements Component {
	public UnitTestXCTestTestSuiteComponentImpl(ComponentIdentifier identifier, @Provided ObjectFactory objects, @Provided ProviderFactory providers, @Provided TaskContainer tasks, @Provided ProjectLayout layout, @Provided ConfigurationContainer configurations, @Provided DependencyHandler dependencyHandler, @Provided NativeComponentDependenciesFactory dependenciesFactory, @Provided DefaultNativeDependenciesBuilderFactory dependenciesBuilderFactory) {
		super(identifier, objects, providers, tasks, layout, configurations, dependencyHandler, dependenciesFactory, dependenciesBuilderFactory);
	}
