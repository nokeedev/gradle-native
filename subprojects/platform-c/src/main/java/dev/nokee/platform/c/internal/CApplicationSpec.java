...
public  /*final*/ abstract class CApplicationSpec extends ModelElementSupport implements CApplication
	...
	, ObjectsTaskMixIn {
	@Inject
	public CApplicationSpec(ModelObjectRegistry<DependencyBucket> bucketRegistry, ModelObjectRegistry<Task> taskRegistry, Factory<SourceView<LanguageSourceSet>> sourcesFactory) {
