...
public abstract /*final*/ class DefaultObjectiveCLibrary extends ObjectiveCLibrarySpec implements INativeComponentSpec<ObjectiveCLibrarySpec>
	, VariantComponentSpec<DefaultObjectiveCLibrary.Variant>
{
	public static abstract /*final*/ class Variant extends ObjectiveCLibrarySpec implements IVariantOf<ObjectiveCLibrarySpec>
		, NativeVariantSpec
		, NativeSourcesAware
		...
		, NativePlatformPluginSupport.VariantOf<DefaultObjectiveCLibrary>
	{
		@Inject
