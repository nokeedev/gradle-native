...
public final class ObjectiveCLibrarySourcesAdapter implements ObjectiveCLibrarySources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public ObjectiveCLibrarySourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
