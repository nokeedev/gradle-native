...
public final class ObjectiveCApplicationSourcesAdapter implements ObjectiveCApplicationSources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public ObjectiveCApplicationSourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
