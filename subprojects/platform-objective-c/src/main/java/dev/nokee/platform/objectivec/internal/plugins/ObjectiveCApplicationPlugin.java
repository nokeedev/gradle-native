...
public class ObjectiveCApplicationPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		project.getExtensions().getByType(ModelLookup.class).get(ModelPath.path("components")).getComponent(ModelComponentType.componentOf(NodeRegistrationFactories.class)).registerFactory(ModelType.of(ObjectiveCApplicationSpec.class), name -> objectiveCApplication(name, project));
		val components = project.getExtensions().getByType(ComponentContainer.class);
		val componentElement = components.register("main", ObjectiveCApplicationSpec.class);
		val componentProvider = componentElement.as(ObjectiveCApplication.class);
	...
	public interface ObjectiveCApplicationSpec extends ComponentSpec {}
