...
public final class PerformanceExperiment implements Comparable<PerformanceExperiment> {
    ...
    public String getDisplayName() {
        return scenario.getTestName() + " | " + getTestProject() + " | " + scenario.getSimpleClassName();
    }
