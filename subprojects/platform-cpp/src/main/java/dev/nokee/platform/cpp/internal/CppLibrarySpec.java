...
public  /*final*/ abstract class CppLibrarySpec extends ModelElementSupport implements CppLibrary
	...
	, ObjectsTaskMixIn {
	@Inject
	public CppLibrarySpec(ModelObjectRegistry<DependencyBucket> bucketRegistry, ModelObjectRegistry<Task> taskRegistry, Factory<SourceView<LanguageSourceSet>> sourcesFactory) {
