...
public /*final*/ abstract class DefaultCppApplication extends CppApplicationSpec implements INativeComponentSpec<CppApplicationSpec>
	, VariantComponentSpec<DefaultCppApplication.Variant>
{
	public static abstract class Variant extends CppApplicationSpec implements IVariantOf<CppApplicationSpec>, VariantInternal
		, NativeVariant
		, NativeSourcesAware
