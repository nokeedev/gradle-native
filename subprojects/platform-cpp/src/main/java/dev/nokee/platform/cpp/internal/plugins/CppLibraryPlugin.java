...
public class CppLibraryPlugin implements Plugin<Project> {
	...
	public static /*final*/ abstract class DefaultCppLibrary extends ModelElementSupport implements CppLibrary
