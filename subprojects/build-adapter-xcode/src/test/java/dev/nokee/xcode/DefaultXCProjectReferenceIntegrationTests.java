...
class DefaultXCProjectReferenceIntegrationTests {
	@Mock XCLoader<Object, XCProjectReference> loader;
	@TempDir Path testDirectory;
	DefaultXCProjectReference subject;

	@BeforeEach
	void createSubject() {
		new EmptyProject().writeToProject(testDirectory);
		subject = new DefaultXCProjectReference(testDirectory.resolve("Empty.xcodeproj"));
	}
