...
class DefaultXCWorkspaceReferenceIntegrationTests {
	@Mock XCLoader<Object, XCWorkspaceReference> loader;
	@TempDir Path testDirectory;
	DefaultXCWorkspaceReference subject;

	@BeforeEach
	void createSubject() {
		new EmptyWorkspace().writeToProject(testDirectory);
		subject = new DefaultXCWorkspaceReference(testDirectory.resolve("Empty.xcworkspace"));
	}
