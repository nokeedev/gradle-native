...
public final class XCFileReferencesLoader implements XCLoader<DefaultXCTargetReference.XCFileReferences, XCProjectReference> {
	...
	@Override
	public DefaultXCTargetReference.XCFileReferences load(XCProjectReference reference) {
