...
public final class XCLoaders {
	...
	private static final XCLoader<XCProject, XCProjectReference> PROJECT_LOADER = new XCCacheLoader<>(new XCProjectLoader(FILE_REFERENCES_LOADER, ALL_TARGETS_LOADER));
