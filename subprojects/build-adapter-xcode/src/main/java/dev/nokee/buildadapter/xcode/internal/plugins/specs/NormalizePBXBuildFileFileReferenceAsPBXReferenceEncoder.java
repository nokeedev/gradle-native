...
public final class NormalizePBXBuildFileFileReferenceAsPBXReferenceEncoder implements ValueEncoder<PBXReference, Object> {
	...
	public NormalizePBXBuildFileFileReferenceAsPBXReferenceEncoder() {
		this(new ThrowingValueEncoder<>(CoderType.of(PBXReference.class)));
	}
	...
	public CoderType<?> getEncodeType() {
		return CoderType.of(PBXReference.class);
	}
}
