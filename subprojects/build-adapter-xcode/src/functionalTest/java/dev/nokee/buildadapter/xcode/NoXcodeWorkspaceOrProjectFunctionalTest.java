...
class NoXcodeWorkspaceOrProjectFunctionalTest {
	...
	@Test
	void warnXcodeBuildAdapterHasNoEffectOnTheBuild() {
		assertThat(result.getOutput(), containsStringIgnoringCase("'dev.nokee.xcode-build-adapter' has no effect"));
	}
