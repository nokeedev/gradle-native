...
import static dev.gradleplugins.buildscript.blocks.GradleBuildScriptBlocks.dependencies;
...
class NokeeApiDependencyFunctionalTest {
	...
	private static Consumer<DependenciesBlock> implementation(DependencyNotation notation) {
