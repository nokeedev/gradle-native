...
@IntegrationTest
abstract class NativeLinkLibrariesConfigurationIntegrationTester<T extends NativeBinary> {
	...
	void initializeSubject() {
		createSubject("fifi");
		this.subject = realize(project.getConfigurations().getByName("fifiLinkLibraries"));
	}
	...
	@Test
	void hasDescription() {
		assertThat(subject, description("Link libraries for binary ':fifi'."));
	}
