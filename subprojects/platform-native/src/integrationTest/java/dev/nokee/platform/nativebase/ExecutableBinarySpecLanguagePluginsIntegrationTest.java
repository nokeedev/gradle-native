...
class ExecutableBinarySpecLanguagePluginsIntegrationTest extends NativeBinaryLanguagePluginsIntegrationTester {
	public NativeBinary createSubject(String name) {
		...
		return registry.register(factory.create(projectIdentifier.child(name))).as(NativeBinary.class).get();
	}
}
