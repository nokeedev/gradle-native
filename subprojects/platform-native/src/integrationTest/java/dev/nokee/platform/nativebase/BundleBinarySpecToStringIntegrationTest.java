...
class BundleBinarySpecToStringIntegrationTest {
	...
	void createSubject() {
		...
		subject = registry.register(factory.create(BinaryIdentifier.of(projectIdentifier, "qube"))).as(BundleBinary.class).get();
	}

	@Test
	void checkToString() {
		assertThat(subject, hasToString("bundle binary 'qube'"));
	}
}
