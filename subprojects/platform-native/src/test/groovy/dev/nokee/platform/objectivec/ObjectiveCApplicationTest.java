...
@Subject(ObjectiveCApplicationExtension.class)
class ObjectiveCApplicationTest implements SourceAwareComponentTester<ObjectiveCApplicationExtension> {
	@Getter @TempDir File testDirectory;

	@Override
	public ObjectiveCApplicationExtension createSubject(String componentName) {
