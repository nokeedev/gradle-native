...
@Subject(NativeApplicationComponentDependenciesImpl)
class NativeApplicationComponentDependenciesImplTest extends AbstractBaseComponentDependenciesContainerTest<NativeApplicationComponentDependenciesImpl> {
	@Override
	protected NativeApplicationComponentDependenciesImpl newSubject(ComponentDependenciesContainer delegate) {
		return new NativeApplicationComponentDependenciesImpl(delegate)
	}
