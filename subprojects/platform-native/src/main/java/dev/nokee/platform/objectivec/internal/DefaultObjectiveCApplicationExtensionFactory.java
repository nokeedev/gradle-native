...
public final class DefaultObjectiveCApplicationExtensionFactory extends AutoDefaultObjectiveCApplicationExtensionFactory {
	...
	@Inject
	public DefaultObjectiveCApplicationExtensionFactory(Provider<ObjectFactory> objectsProvider, Provider<ProviderFactory> providersProvider, Provider<ProjectLayout> layoutProvider, Provider<DefaultNativeApplicationComponentFactory> componentFactoryProvider, MembersInjector<DecoratingFactory> injector) {
	...
	@Override
	public DefaultObjectiveCApplicationExtension create(ComponentIdentifier identifier) {
