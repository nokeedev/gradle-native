...
public final class DefaultCApplicationExtensionFactory extends AutoDefaultCApplicationExtensionFactory {
	...
	@Inject
	public DefaultCApplicationExtensionFactory(Provider<ObjectFactory> objectsProvider, Provider<ProviderFactory> providersProvider, Provider<ProjectLayout> layoutProvider, Provider<DefaultNativeApplicationComponentFactory> componentFactoryProvider, MembersInjector<DecoratingFactory> injector) {
	...
	@Override
	public DefaultCApplicationExtension create(ComponentIdentifier identifier) {
