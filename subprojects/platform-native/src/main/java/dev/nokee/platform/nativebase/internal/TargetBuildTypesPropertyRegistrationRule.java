...
public final class TargetBuildTypesPropertyRegistrationRule extends ModelActionWithInputs.ModelAction1<TypeCompatibilityModelProjectionSupport<ModelBackedTargetBuildTypeAwareComponentMixIn>> {
	...
	@Override
	protected void execute(ModelNode entity, TypeCompatibilityModelProjectionSupport<ModelBackedTargetBuildTypeAwareComponentMixIn> tag) {
