...
public final class NativeApplicationSourcesAdapter implements NativeApplicationSources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public NativeApplicationSourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
