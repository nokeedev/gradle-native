...
public final class RequestFrameworkAction implements Action<ModuleDependency> {
	...
	public void execute(ModuleDependency dependency) {
		if (isFrameworkNotation(dependency)) {
	...
	private static boolean isFrameworkNotation(Dependency notation) {
		return NOKEE_MAGIC_FRAMEWORK_GROUP.equals(notation.getGroup());
	}
}
