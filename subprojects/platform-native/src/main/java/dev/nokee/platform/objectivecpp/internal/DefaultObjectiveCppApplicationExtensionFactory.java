...
public final class DefaultObjectiveCppApplicationExtensionFactory extends AutoDefaultObjectiveCppApplicationExtensionFactory {
	...
	@Inject
	public DefaultObjectiveCppApplicationExtensionFactory(Provider<ObjectFactory> objectsProvider, Provider<ProviderFactory> providersProvider, Provider<ProjectLayout> layoutProvider, Provider<DefaultNativeApplicationComponentFactory> componentFactoryProvider, MembersInjector<DecoratingFactory> injector) {
	...
	@Override
	public DefaultObjectiveCppApplicationExtension create(ComponentIdentifier identifier) {
