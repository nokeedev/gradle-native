...
public class DefaultNativeLibraryComponent extends BaseNativeComponent<NativeLibrary> implements Component
	...
	, ModelBackedHasAssembleTaskMixIn
{
	...
	@Inject
	public DefaultNativeLibraryComponent(ComponentIdentifier identifier, TaskRegistry taskRegistry) {
		super(identifier);
