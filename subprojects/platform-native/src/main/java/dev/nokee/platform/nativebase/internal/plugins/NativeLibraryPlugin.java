	...
	public static NodeRegistration nativeLibraryVariant(VariantIdentifier<DefaultNativeLibraryVariant> identifier, DefaultNativeLibraryComponent component, Project project) {
		return NodeRegistration.unmanaged(identifier.getUnambiguousName(), of(NativeLibrary.class), () -> {
			...
			.action(self(discover()).apply(ModelActionWithInputs.of(ModelComponentReference.of(ModelPath.class), (entity, path) -> {
				...
				val api = registry.register(bucketFactory.create(path.child("api"), DependencyBucketIdentifier.of(declarable("api"), identifier)));
				...
				if (hasSwift) {
					apiElements = registry.register(consumableFactory.create(path.child("apiElements"), DependencyBucketIdentifier.of(consumable("apiElements"), identifier)));
				...
				val linkElements = registry.register(consumableFactory.create(path.child("linkElements"), DependencyBucketIdentifier.of(consumable("linkElements"), identifier)));
