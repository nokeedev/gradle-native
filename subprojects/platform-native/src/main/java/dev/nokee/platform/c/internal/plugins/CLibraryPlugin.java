...
public class CLibraryPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		val sources = DaggerCPlatformComponents.factory().create(project).librarySources();
		...
		DefaultCLibraryExtension extension = getObjects().newInstance(DefaultCLibraryExtension.class, component.get(), sources);
