...
public class CLibraryPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		components.registerFactory(DefaultCLibraryExtension.class, id -> {
			...
			return new DefaultCLibraryExtension(component, project.getObjects(), project.getProviders(), project.getLayout(), project.getExtensions().getByType(LanguageSourceSetRegistry.class));
		});
