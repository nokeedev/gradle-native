...
public class CppApplicationPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		val sources = DaggerCppPlatformComponents.factory().create(project).applicationSources();
		...
		DefaultCppApplicationExtension extension = getObjects().newInstance(DefaultCppApplicationExtension.class, component.get(), sources);
