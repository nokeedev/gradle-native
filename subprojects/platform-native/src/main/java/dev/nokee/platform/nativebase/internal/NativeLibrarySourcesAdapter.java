...
public final class NativeLibrarySourcesAdapter implements NativeLibrarySources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public NativeLibrarySourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
