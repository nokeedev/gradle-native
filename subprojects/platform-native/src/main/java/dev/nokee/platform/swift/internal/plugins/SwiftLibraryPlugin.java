...
public class SwiftLibraryPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		components.registerFactory(DefaultSwiftLibraryExtension.class, id -> {
			...
			return new DefaultSwiftLibraryExtension(component, project.getObjects(), project.getProviders(), project.getLayout(), project.getExtensions().getByType(LanguageSourceSetRegistry.class));
		});
