...
public final class LegacyObjectiveCSourceLayoutConvention extends ModelActionWithInputs.ModelAction3<SourcePropertyComponent, ParentComponent, ModelProjection> {

	public LegacyObjectiveCSourceLayoutConvention() {
		super(ModelComponentReference.of(SourcePropertyComponent.class), ModelComponentReference.of(ParentComponent.class), ModelComponentReference.ofProjection(ObjectiveCSourceSet.class));
	}
