...
public final class DefaultSwiftLibraryExtensionFactory extends AutoDefaultSwiftLibraryExtensionFactory {
	...
	@Inject
	public DefaultSwiftLibraryExtensionFactory(Provider<ObjectFactory> objectsProvider, Provider<ProviderFactory> providersProvider, Provider<ProjectLayout> layoutProvider, Provider<DefaultNativeLibraryComponentFactory> componentFactoryProvider, MembersInjector<DecoratingFactory> injector) {
	...
	@Override
	public DefaultSwiftLibraryExtension create(ComponentIdentifier identifier) {
