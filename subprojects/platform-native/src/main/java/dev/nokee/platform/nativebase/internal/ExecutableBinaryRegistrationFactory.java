...
public final class ExecutableBinaryRegistrationFactory {
	public ModelRegistration create(ModelObjectIdentifier identifier) {
		return ModelRegistration.builder()
			...
			.withComponent(new MainProjectionComponent(ModelBackedExecutableBinary.class))
			.build();
	}

	public static /*final*/ abstract class ModelBackedExecutableBinary extends ModelElementSupport implements ExecutableBinary, HasPublicType, ModelNodeAware
