...
public final class ExecutableBinaryRegistrationFactory {
	...
	public ExecutableBinaryRegistrationFactory(ObjectFactory objectFactory) {
	...
	public ModelRegistration create(BinaryIdentifier identifier) {
		return ModelRegistration.builder()
			...
			.withComponent(createdUsing(of(ModelBackedExecutableBinary.class), () -> new ModelBackedExecutableBinary(objectFactory)))
			.build();
	}

	public static final class ModelBackedExecutableBinary implements ExecutableBinary, HasPublicType, ModelNodeAware
