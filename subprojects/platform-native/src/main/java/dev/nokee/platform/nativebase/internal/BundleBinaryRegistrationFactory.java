...
public final class BundleBinaryRegistrationFactory {
		...
		, CompileTasksMixIn
	{
		...
		@Inject
		public ModelBackedBundleBinary(ModelObjectRegistry<Task> taskRegistry, ModelObjectRegistry<DependencyBucket> bucketRegistry, Factory<TaskView<SourceCompile>> compileTasksFactory, ObjectFactory objectFactory) {
