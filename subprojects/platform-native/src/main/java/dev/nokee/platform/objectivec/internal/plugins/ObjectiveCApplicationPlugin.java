...
public class ObjectiveCApplicationPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		val sources = DaggerObjectiveCPlatformComponents.factory().create(project).applicationSources();
		...
		DefaultObjectiveCApplicationExtension extension = getObjects().newInstance(DefaultObjectiveCApplicationExtension.class, component.get(), sources);
