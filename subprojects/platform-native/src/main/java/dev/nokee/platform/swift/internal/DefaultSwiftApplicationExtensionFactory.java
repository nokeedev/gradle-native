...
public final class DefaultSwiftApplicationExtensionFactory extends AutoDefaultSwiftApplicationExtensionFactory {
	...
	@Inject
	public DefaultSwiftApplicationExtensionFactory(Provider<ObjectFactory> objectsProvider, Provider<ProviderFactory> providersProvider, Provider<ProjectLayout> layoutProvider, Provider<DefaultNativeApplicationComponentFactory> componentFactoryProvider, MembersInjector<DecoratingFactory> injector) {
	...
	@Override
	public DefaultSwiftApplicationExtension create(ComponentIdentifier identifier) {
