...
public class ObjectiveCppLibraryPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		val extension = new DefaultObjectiveCppLibraryExtension(componentProvider.get(), project.getObjects(), project.getProviders(), project.getLayout(), project.getExtensions().getByType(LanguageSourceSetRegistry.class));
