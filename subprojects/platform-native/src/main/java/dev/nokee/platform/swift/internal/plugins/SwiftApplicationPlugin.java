...
public class SwiftApplicationPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		components.registerFactory(DefaultSwiftApplicationExtension.class, id -> {
			...
			return new DefaultSwiftApplicationExtension(component, project.getObjects(), project.getProviders(), project.getLayout(), project.getExtensions().getByType(LanguageSourceSetRegistry.class));
		});
