...
public class DefaultDependencyBucketFactory implements DependencyBucketFactory {
	...
	public DefaultDependencyBucketFactory(NamedDomainObjectRegistry<Configuration> configurationRegistry, DependencyFactory dependencyFactory) {
	...
	public DependencyBucket create(DependencyBucketIdentifier identifier) {
		...
		return new DefaultDependencyBucket(identifier.getName().toString(), configurationProvider, dependencyFactory);
	}
}
