...
public interface RuntimeOnlyDependencyBucketMixIn extends HasRuntimeOnlyDependencyBucket {
	@Override
	@NestedObject
	DeclarableDependencyBucketSpec getRuntimeOnly();
	...
	default void runtimeOnly(Project project, Action<? super ProjectDependency> configureAction) {
		getRuntimeOnly().addDependency(project, configureAction);
	}
