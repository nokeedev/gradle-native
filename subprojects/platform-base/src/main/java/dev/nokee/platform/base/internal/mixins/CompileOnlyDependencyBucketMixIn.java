...
public interface CompileOnlyDependencyBucketMixIn extends HasCompileOnlyDependencyBucket {
	@Override
	@NestedObject
	DeclarableDependencyBucketSpec getCompileOnly();
	...
	default void compileOnly(Project project, Action<? super ProjectDependency> configureAction) {
		getCompileOnly().addDependency(project, configureAction);
	}
