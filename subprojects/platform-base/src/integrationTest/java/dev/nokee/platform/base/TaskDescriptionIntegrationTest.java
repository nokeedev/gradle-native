...
class TaskDescriptionIntegrationTest {
	...
	@Test
	void configuresTaskProjectionDescriptionWithTaskDescriptionComponent() {
		subject.addComponent(new TaskDescriptionComponent("Some task description."));
		assertThat(task.get(), TaskMatchers.description("Some task description."));
	}
}
