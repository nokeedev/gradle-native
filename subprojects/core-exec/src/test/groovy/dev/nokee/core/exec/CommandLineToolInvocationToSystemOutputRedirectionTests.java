...
class CommandLineToolInvocationToSystemOutputRedirectionTests implements CommandLineToolInvocationOutputRedirectionTester<CommandLineToolInvocationOutputRedirection.ToSystemOutputRedirection> {
	CommandLineToolInvocationOutputRedirection.ToSystemOutputRedirection subject = new CommandLineToolInvocationOutputRedirection.ToSystemOutputRedirection();

	@Override
	public CommandLineToolInvocationOutputRedirection.ToSystemOutputRedirection subject() {
		return subject;
	}
	...
	public void testToString(String subjectToString) {
		assertThat(subjectToString, equalTo("toSystemOut()"));
	}

	@Test
	void returnsSystemOut() throws IOException {
