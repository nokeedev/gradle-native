...
public final class DefaultComponentRegistry implements ModelComponentRegistry {
	...
	@Override
	public <T extends ModelComponent> void set(ModelEntityId entityId, ModelComponentType<T> componentId, T component) {
		components.computeIfAbsent(entityId, __ -> new LinkedHashMap<>()).put(componentId, component);
	}
