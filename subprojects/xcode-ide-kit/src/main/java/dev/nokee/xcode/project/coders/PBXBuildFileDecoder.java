...
@EqualsAndHashCode
public final class PBXBuildFileDecoder<T extends PBXBuildFile & Codeable> implements ValueDecoder<T, KeyedObject> {
	@Override
	...
	@Override
	public CoderType<PBXBuildFile> getDecodeType() {
