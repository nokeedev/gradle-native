...
@Nested
class XCSwiftPackageProductDependencyCoderTests {
	@ParameterizedTest
	@EnumSource(CodeableXCSwiftPackageProductDependency.CodingKeys.class)
	...
	@Test
	void hasPackageCoder() {
		assertThat(KeyedCoders.DECODERS.get(packageReference), ofKey("package").asRefObject(XCRemoteSwiftPackageReferenceFactory.class));
	}
}
