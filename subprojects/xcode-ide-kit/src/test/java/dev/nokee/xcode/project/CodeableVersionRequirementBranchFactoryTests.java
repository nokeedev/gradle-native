...
class CodeableVersionRequirementBranchFactoryTests {
	@Test
	void canCreateBranchRequirement() {
		assertThat(branch("master"),
			equalTo(new CodeableVersionRequirementBranch(new DefaultKeyedObject(of(kind, BRANCH, branch, "master")))));
	}
}
