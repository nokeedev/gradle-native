...
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.buildConfigurationList;
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.buildPhases;
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.dependencies;
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.name;
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.productName;
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.productReference;
import static dev.nokee.xcode.project.CodeablePBXAggregateTarget.CodingKeys.productType;
...
class CodeablePBXAggregateTargetTests extends CodeableAdapterTester<CodeablePBXAggregateTarget> implements VisitableTester<PBXTarget.Visitor<?>> {
	@ParameterizedTest
