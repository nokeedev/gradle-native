...
class CodeablePBXLegacyTargetTests {
	@Mock
	KeyedObject map;
	@InjectMocks
	CodeablePBXLegacyTarget subject;
	...
	void checkGetBuildArgumentsString(String expectedValue) {
		...
		verify(map).tryDecode(buildArgumentsString);
	}
	...
	void checkGetBuildToolPath(String expectedValue) {
		...
		verify(map).tryDecode(buildToolPath);
	}
	...
	void checkGetBuildWorkingDirectory(String expectedValue) {
		...
		verify(map).tryDecode(buildWorkingDirectory);
	}
	...
	void checkIsPassBuildSettingsInEnvironment(Boolean expectedValue) {
		...
		verify(map).tryDecode(passBuildSettingsInEnvironment);
	}
