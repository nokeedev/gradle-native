...
@Nested
class VersionRequirementRevisionCoderTests {
	@ParameterizedTest
	@EnumSource(CodeableVersionRequirementRevision.CodingKeys.class)
	...
	@Test
	void hasRevisionCoder() {
		assertThat(KeyedCoders.DECODERS.get(revision), ofKey("revision").asString());
	}
}
