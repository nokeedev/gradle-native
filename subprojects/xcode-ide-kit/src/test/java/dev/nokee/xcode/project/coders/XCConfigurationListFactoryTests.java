...
public class XCConfigurationListFactoryTests {
	@Mock
	KeyedObject map;
	@InjectMocks
	XCConfigurationListFactory<?> subject;

	@Nested
	class WhenIsaXCConfigurationList {
		@BeforeEach
		void givenIsaXCConfigurationList() {
			when(map.isa()).thenReturn("XCConfigurationList");
		}
