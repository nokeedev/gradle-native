...
@Nested
class VersionRequirementBranchCoderTests {
	@ParameterizedTest
	@EnumSource(CodeableVersionRequirementBranch.CodingKeys.class)
	...
	@Test
	void hasBranchCoder() {
		assertThat(KeyedCoders.DECODERS.get(branch), ofKey("branch").asString());
	}
}
