...
public class PBXTargetDependencyFactoryTests {
	@Mock
	KeyedObject map;
	@InjectMocks
	PBXTargetDependencyFactory<?> subject;

	@Nested
	class WhenIsaPBXTargetDependency {
		@BeforeEach
		void givenIsaPBXTargetDependency() {
			when(map.isa()).thenReturn("PBXTargetDependency");
		}
