...
class CodeableVersionRequirementExactFactoryTests {
	@Test
	void canCreateExactRequirement() {
		assertThat(exact("4.5"),
			equalTo(new CodeableVersionRequirementExact(new DefaultKeyedObject(of(kind, EXACT, version, "4.5")))));
	}
}
