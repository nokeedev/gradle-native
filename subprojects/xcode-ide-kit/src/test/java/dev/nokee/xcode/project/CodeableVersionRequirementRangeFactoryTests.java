...
class CodeableVersionRequirementRangeFactoryTests {
	@Test
	void canCreateRangeRequirement() {
		assertThat(range("1.2", "1.5"),
			equalTo(new CodeableVersionRequirementRange(new DefaultKeyedObject(of(kind, RANGE, minimumVersion, "1.2", maximumVersion, "1.5")))));
	}
}
