...
@Nested
class VersionRequirementExactCoderTests {
	@ParameterizedTest
	@EnumSource(CodeableVersionRequirementExact.CodingKeys.class)
	...
	@Test
	void hasVersionCoder() {
		assertThat(KeyedCoders.DECODERS.get(version), ofKey("version").asString());
	}
}
