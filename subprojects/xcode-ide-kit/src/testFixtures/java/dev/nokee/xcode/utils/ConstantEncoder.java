...
public final class ConstantEncoder<OUT, IN> implements ValueEncoder<OUT, IN>, HasInvocationResults<InvocationResult2<IN, ValueEncoder.Context>> {
	private final List<InvocationResult2<IN, Context>> invocations = new ArrayList<>();
	private final OUT returnValue;

	public ConstantEncoder(OUT returnValue) {
	...
	@Override
	public OUT encode(IN ignored, Context context) {
