...
{
	@Subject NamedDomainObjectProvider<CppSourceSetSpec> subject;

	NamedDomainObjectProvider<CppSourceSetSpec> createSubject() {
		return sources(project).register("zomi", CppSourceSetSpec.class);
	}
