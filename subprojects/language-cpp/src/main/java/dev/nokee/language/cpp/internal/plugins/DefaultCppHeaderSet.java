...
public class DefaultCppHeaderSet implements CppHeaderSet, HasPublicType, ModelBackedLanguageSourceSetLegacyMixIn<NativeHeaderSet>, HasConfigurableSourceMixIn {
	@Override
