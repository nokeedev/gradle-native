...
class NamedDomainObjectCollectionUtils_CreateIfAbsentTest {
	...
	void throwsExceptionWhenCreateTypeIsUnrelatedTypeOfExistingElement() {
		...
		assertThat(ex.getMessage(),
			equalTo("Could not register element 'existing': Element type requested (dev.gradleplugins.grava.util.NamedDomainObjectCollectionUtils_CreateIfAbsentTest.ChildBElement) does not match actual type (dev.gradleplugins.grava.util.NamedDomainObjectCollectionUtils_CreateIfAbsentTest.Element)."));
	}
