...
import static dev.gradleplugins.grava.util.TransformerUtils.compose;
import static dev.gradleplugins.grava.util.TransformerUtils.noOpTransformer;
import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.*;

@Subject(dev.gradleplugins.grava.util.TransformerUtils.class)
class TransformerUtils_ComposeTest {
	...
	void returnsEnhanceTransformer() {
		assertThat(compose(aTransformer(), aTransformer()), isA(dev.gradleplugins.grava.util.TransformerUtils.Transformer.class));
	}
