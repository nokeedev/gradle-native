...
public class ObjectiveCppLibraryPlugin implements Plugin<Project> {
	...
	public static ModelRegistration objectiveCppLibrary(String name, Project project) {
		...
		return new NativeLibraryComponentModelRegistrationFactory(DefaultObjectiveCppLibrary.class, project).create(identifier).build();
	}

	public static /*final*/ abstract class DefaultObjectiveCppLibrary extends ModelElementSupport implements ObjectiveCppLibrary
