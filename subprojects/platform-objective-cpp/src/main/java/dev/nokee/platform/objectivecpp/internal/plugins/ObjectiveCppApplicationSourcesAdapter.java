...
public final class ObjectiveCppApplicationSourcesAdapter implements ObjectiveCppApplicationSources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public ObjectiveCppApplicationSourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
