...
public class ObjectiveCppApplicationPlugin implements Plugin<Project> {
	...
	public static ModelRegistration objectiveCppApplication(String name, Project project) {
		...
		return new NativeApplicationComponentModelRegistrationFactory(ObjectiveCppApplication.class, DefaultObjectiveCppApplication.class, project, (entity, path) -> {
			...
			registry.register(project.getExtensions().getByType(ObjectiveCppSourceSetRegistrationFactory.class).create(LanguageSourceSetIdentifier.of(entity.getComponent(ComponentIdentifier.class), "objectiveCpp"), true));
			...
			registry.register(project.getExtensions().getByType(ComponentSourcesPropertyRegistrationFactory.class).create(ModelPropertyIdentifier.of(identifier, "sources"), ObjectiveCppApplicationSources.class, ObjectiveCppApplicationSourcesAdapter::new));
