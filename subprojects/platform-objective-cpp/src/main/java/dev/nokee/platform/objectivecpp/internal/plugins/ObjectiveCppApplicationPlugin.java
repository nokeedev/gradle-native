...
public class ObjectiveCppApplicationPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		model(project, factoryRegistryOf(Component.class)).registerFactory(ObjectiveCppApplicationSpec.class, name -> {
			return project.getObjects().newInstance(ObjectiveCppApplicationSpec.class, model(project, registryOf(Task.class)), project.getExtensions().getByType(new TypeOf<Factory<SourceView<LanguageSourceSet>>>() {}));
		});
