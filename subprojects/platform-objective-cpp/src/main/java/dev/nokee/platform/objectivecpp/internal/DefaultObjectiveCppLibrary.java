...
public abstract /*final*/ class DefaultObjectiveCppLibrary extends ObjectiveCppLibrarySpec implements INativeComponentSpec<ObjectiveCppLibrarySpec>
	, VariantComponentSpec<DefaultObjectiveCppLibrary.Variant>
{
	public static abstract /*final*/ class Variant extends ObjectiveCppLibrarySpec implements IVariantOf<ObjectiveCppLibrarySpec>, VariantInternal
		, NativeVariant
		, NativeSourcesAware
