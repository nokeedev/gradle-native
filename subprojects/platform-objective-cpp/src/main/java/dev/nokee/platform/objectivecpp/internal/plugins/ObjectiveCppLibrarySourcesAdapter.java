...
public final class ObjectiveCppLibrarySourcesAdapter implements ObjectiveCppLibrarySources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public ObjectiveCppLibrarySourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
	...
	@Override
	public NamedDomainObjectProvider<ObjectiveCppSourceSet> getObjectiveCpp() {
		return named("objectiveCpp", ObjectiveCppSourceSet.class);
	}

	@Override
	public void objectiveCpp(Action<? super ObjectiveCppSourceSet> action) {
		delegate.named("objectiveCpp", ObjectiveCppSourceSet.class, action);
	}

	@Override
	public void objectiveCpp(@SuppressWarnings("rawtypes") Closure closure) {
		delegate.named("objectiveCpp", ObjectiveCppSourceSet.class, closure);
	}
	...
	@Override
	public NamedDomainObjectProvider<NativeHeaderSet> getPublic() {
		return named("public", NativeHeaderSet.class);
	}
}
