...
For more information, see <<../../manual/{plugin-language-id}-application-plugin.adoc.adoc#,{plugin-language} Application Plugin>> reference chapter and <<../../manual/building-native-projects.adoc.adoc#,Building Native Projects>> chapter.
