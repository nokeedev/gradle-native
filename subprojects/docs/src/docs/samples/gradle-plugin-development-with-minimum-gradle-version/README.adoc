...
The plugin only has dependencies on the redistributed Gradle API, <<../../gradle-plugin-development.adoc#sec:gradle-dev-redistributed-gradle-api,see this chapter for more information>>.
...
=====
====
<1> See Gradle plugin test suites section of the user manual, and the test suites sample.
