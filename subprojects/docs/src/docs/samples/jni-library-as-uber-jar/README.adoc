...
The library has no dependencies and targets Windows x86/x64, Linux x86-64 and macOS x86-64.
...
----
$ ls ./build/libs/*.jar
./build/libs/jni-library-as-uber-jar-macos-x86-64.jar
...
[listing.terminal,only-if='macos']
----
$ jar tf ./build/libs/jni-library-as-uber-jar-macos-x86-64.jar
META-INF/
META-INF/MANIFEST.MF
macos-x86-64/
macos-x86-64/libjni-library-as-uber-jar.dylib
