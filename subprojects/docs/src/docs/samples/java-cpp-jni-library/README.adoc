= JNI Library implemented in Java and {cpp}
:jbake-type: sample_chapter
:jbake-tags: sample, jni
:jbake-description: See how to Nokee Gradle plugins are used for building a Java Native Interface (JNI) library implemented in Java and {cpp}.
