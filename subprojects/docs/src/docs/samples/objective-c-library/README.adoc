...
For more information, see <<../../manual/{plugin-language-id}-library-plugin.adoc.adoc#,{plugin-language} Library Plugin>> reference chapter and <<../../manual/building-native-projects.adoc.adoc#,Building Native Projects>> chapter.
