<nav class="navigation" aria-labelledby="primary-navigation">
	...
	<ul class="navigation-items">
		<li><a href="/docs/current/manual/user_manual.html">Docs</a></li>
		<li><a href="/blog">Blog</a></li>
		<li><a href="https://github.com/nokeedev" title="Nokee on GitHub"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title>
