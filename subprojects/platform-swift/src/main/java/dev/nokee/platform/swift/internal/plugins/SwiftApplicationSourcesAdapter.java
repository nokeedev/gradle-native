...
public final class SwiftApplicationSourcesAdapter implements SwiftApplicationSources {
	private final ViewAdapter<LanguageSourceSet> delegate;

	public SwiftApplicationSourcesAdapter(ViewAdapter<LanguageSourceSet> delegate) {
