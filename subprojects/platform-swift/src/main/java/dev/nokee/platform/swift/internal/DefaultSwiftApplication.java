...
public /*final*/ abstract class DefaultSwiftApplication extends SwiftApplicationSpec implements INativeComponentSpec<SwiftApplicationSpec>
	, VariantComponentSpec<DefaultSwiftApplication.Variant>
{
	public static abstract class Variant extends SwiftApplicationSpec implements IVariantOf<SwiftApplicationSpec>
		, NativeVariantSpec
		, NativeSourcesAware
		, RuntimeElementsDependencyBucketMixIn
		, HasBinaryLifecycleTask
		, NativePlatformPluginSupport.VariantOf<DefaultSwiftApplication>
		, ParentAware
	{
		@Inject
