...
public  /*final*/ abstract class SwiftApplicationSpec extends ModelElementSupport implements SwiftApplication
	...
	, ObjectsTaskMixIn {
	@Inject
	public SwiftApplicationSpec(ModelObjectRegistry<DependencyBucket> bucketRegistry, ModelObjectRegistry<Task> taskRegistry, Factory<SourceView<LanguageSourceSet>> sourcesFactory) {
